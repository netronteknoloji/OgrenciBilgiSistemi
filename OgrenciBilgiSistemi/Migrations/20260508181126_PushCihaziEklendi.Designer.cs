...
namespace OgrenciBilgiSistemi.Migrations
{
    ...
    [Migration("20260508181126_PushCihaziEklendi")]
    partial class PushCihaziEklendi
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OgrenciBilgiSistemi.Models.BildirimModel", b =>
                {
                    ...
                    b.HasIndex("AliciKullaniciId", "Okundu")
            ...
            modelBuilder.Entity("OgrenciBilgiSistemi.Models.MenuOgeModel", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            Action = "Index",
                            AnaMenuId = 30,
                            Baslik = "Randevu Listesi",
                            Controller = "Randevular",
                            Sirala = 1
                        },
                        new
                        {
            ...
            modelBuilder.Entity("OgrenciBilgiSistemi.Models.OgretmenRandevuModel", b =>
                {
                    b.Property<int>("OgretmenRandevuId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("OgretmenRandevuId"));
                    ...
                    b.Property<int>("OgretmenKullaniciId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("OgrenciBilgiSistemi.Models.PushCihaziModel", b =>
                {
                    b.Property<int>("PushCihaziId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("PushCihaziId"));
                    ...
                    b.HasKey("PushCihaziId");

                    b.HasIndex(new[] { "FcmToken" }, "UX_PushCihazlari_FcmToken_Aktif")
                        .IsUnique()
                        .HasFilter("[IsDeleted] = 0");

                    b.HasIndex(new[] { "KullaniciId", "IsDeleted" }, "IX_PushCihazlari_Kullanici_Aktif");

                    b.ToTable("PushCihazlari");
                });

            modelBuilder.Entity("OgrenciBilgiSistemi.Models.RandevuModel", b =>
                {
                    b.Property<int>("RandevuId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<bool>("OgretmenTarafindanOlusturuldu")
                        .HasColumnType("bit");
                    ...
                    b.Property<int>("VeliKullaniciId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("OgrenciBilgiSistemi.Models.BildirimModel", b =>
                {
                    ...
                    b.HasOne("OgrenciBilgiSistemi.Models.RandevuModel", "Randevu")
                        .WithMany()
            ...
            modelBuilder.Entity("OgrenciBilgiSistemi.Models.OgretmenRandevuModel", b =>
                {
                    b.HasOne("OgrenciBilgiSistemi.Models.KullaniciModel", "Ogretmen")
                        .WithMany()
                        .HasForeignKey("OgretmenKullaniciId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
